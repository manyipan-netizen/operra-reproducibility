...
::: incremental
-   Attempted to rerun **22,578 Jupyter notebooks** associated with 3,467 publications
-   For 10,388 of these, all declared dependencies could be installed successfully
-   1,203 (5%) notebooks ran through without any errors
...
2.  Demonstration → How to use it?

3.  Advanced workflows → What else is possible?
...
![](img/healthcare-AI_2.png){width="40%" fig-align="center"}
...
::: {.column width="25%"}
![[<https://quarto.org/quarto.png>]{style="font-size:0.6em"}](img/quarto.png){fig-align="center"}
:::
::::
...
## Dynamic reporting with Quarto in RStudio

![CC by [Desirée De Leon](https://github.com/dcossyleon)](img/rstudio-rmarkdown.png)
