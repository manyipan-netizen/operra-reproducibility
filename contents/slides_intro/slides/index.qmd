...
3.  Demonstration of an advanced workflow -- What else is possible?

::: fragment
Website with all materials: <https://crsuzh.pages.uzh.ch/workshop-quarto-2025-uzh/>
:::
------------------------------------------------------------------------
...
::: {.column width="28%"}
[![](img/homer-happy.jpg)]{.fragment} [*(images re-used for eduacational purpose)*]{.fragment style="font-size: 0.52em"}
:::
::::::
:::::::
::::::::::::
